...
```json
{
  "company_header": "Arknet Digital Solution",
  "company_slogan": "High Speed Internet Service",
...
```json
{
  "footer_info": "Info Hubungi : 081259872053"
}
```
...
```json
{
  ...
  "payment_account_holder": "Arknet Digital Solution",
